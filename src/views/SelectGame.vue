<template>
  <div class="AccountPage">
    <br><br>
    <div class="top-text"><font color="white" class="toptext">{{iframeData.name}}的精选游戏</font></div>
    <div class="explain-text">
    <ul>
      <li v-for="(game,index) in iframeData.games">
        <div>
          <font color="white" class="exltext">游戏名：{{game.game_name}}</font>
        </div>
        <br>
        <div>
          <font color="white" class="exltext">现价：{{game.pre_price}}$</font>
        </div>
        <br>
        <div>
